        ...
        <div class="col-lg-7 col-md-9 mx-auto">
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    <h4 class="mb-4">Scan Barcode -- SJ/DO From PPIC</h4>

                    <form action="{{ asset('terima_finance') }}" method="post" class="mb-4">
                        {{ csrf_field() }}

                        <div class="mb-3">
                            <label class="form-label">Scan Barcode</label>
                            <input id="a" type="text" class="form-control" placeholder="Scan Barcode" name="doaii" autofocus required>
                        </div>
                    ...
                    <form action="{{ asset('update_fin_upload') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="update_fin_upload" class="form-control" required>
                        </div>
