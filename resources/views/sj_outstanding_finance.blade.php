            ...
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
                        <h4 class="mb-0">Outstanding SJ &gt; 7 Hari (Finance)</h4>
                        <a href="{{ asset('/terima_finance') }}" class="btn btn-warning">Scan Disini &gt;&gt; SJ/DO From Customer</a>
                    </div>

                    <div class="table-responsive">
                        <table id="sj_ppic_more_7_days_finance" class="table table-striped table-hover align-middle w-100">
                            <thead>
                                <tr>
...
initSatriaDataTable('#sj_ppic_more_7_days_finance', {
processing: true,
serverSide: true,
columns: [
...
ajax: satriaAjaxConfig('{!!url("data_outstanding_sj_7_day_finance")!!}')
});
});
</script>
@endsection
